      ...
      <div className={classes.root}>
        ...
        >
          <div className={classes.drawerContent}>
            ...
            >
              ...
              {["Live", "Employees", "Clients", "Reports", "Store"].map(
                (text, index) => {
                  switch (text) {
                    case "Live":
                      return (
            ...
            >
              <h4 style={{ marginLeft: "10px", color: "gray" }}>Build Info</h4>
        ...
        <main className={classes.content}>
          ...
          <div style={{ display: "inline-flex", cursor: "pointer" }}>
            {props.selectedComponent !== "Dashboard" &&
              props.selectedComponent !== "Live" && (
                <p
